...
<html lang="en">
    <head>
        ...
        <title><?= $genre_name; ?> - Stanza Scoop</title>

        <link rel="canonical" href="<?= current_url(); ?>">

        <meta name="description" content="Get the <?= $genre_name ?> lyrics on Stanzascoop and sing a long to your favorite lyrics. Don't miss a word or update.">

        <meta name="twitter:card" content="summary">

        <meta name="twitter:site" content="@stanzascoop">

        <meta name="twitter:title" content="Top <?= $genre_name ?> lyrics on Stanzascoop">

        <meta name="twitter:description" content="Get the <?= $genre_name ?> lyrics on Stanzascoop and sing a long to your favorite lyrics. Don't miss a word or update.">
        ...
        <meta property="og:title" content="Top <?= $genre_name ?> lyrics on Stanzascoop">

        <meta property="og:type" content="article">

        <meta property="og:image" content="<?= base_url('ss/images/android-api.png'); ?>">

        <meta property="og:description" content="Get the <?= $genre_name ?> lyrics on Stanzascoop and sing a long to your favorite lyrics. Don't miss a word or update.">
    ...
    <body id="stanzascoop">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="list-group">
                        <a onclick="viewTrending()" href="<?= base_url('explore/trending'); ?>" class="list-group-item">
                            ...
                            <ul class="filters genres">
                                ...
                                if (count($genres) > 0) {
                                    foreach ($genres as $row):
                                        if ($row->genre_code == $genre_code) {
                                            $genre_active = "active";
                                        } else {
                                            $genre_active = '';
                                        }
                                        ?>
                                        <li class="<?= $genre_active; ?>">
                ...
                <div class="col-md-8">
                    <div class="result-panel">
                        <h1 class="trending-title">
                            <div>Top <?= $genre_name; ?> lyrics</div>
                        </h1>
                        <h2 class="trending-subtitle">
                            <div>Find the lyrics of the most viewed <?= $genre_name; ?> songs on Stanzascoop</div>
                        </h2>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#lyrresults').load("<?php echo base_url() ?>welcome/loadgenre/<?php echo $genre_code; ?>",
                        ...
                        $('#loadmore').on('click', function () {
                            if (total_record <= total_groups)
                            {
                                ...
                                $.post('<?php echo site_url() ?>welcome/loadgenre/<?php echo $genre_code; ?>', {'group_no': total_record},
                                                function (data) {
                                                    if (data !== "") {
