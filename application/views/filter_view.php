            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="list-group">
                        ...
                        <a href="<?= base_url('explore/latest'); ?>" class="list-group-item  <?= $latest_active; ?>">
  ...
  ga('send', 'pageview');
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#lyrresults').load("<?php echo base_url() ?>welcome/loadfilter/<?php echo $orderby ?>",
                        ...
                        $('#loadmore').on('click', function () {
                            if (total_record <= total_groups)
                            {
                                ...
                                $.post('<?php echo site_url() ?>welcome/loadfilter/<?php echo $orderby ?>', {'group_no': total_record},
                                                function (data) {
                                                    if (data !== "") {
